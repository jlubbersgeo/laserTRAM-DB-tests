...
# colors for plotting lines in laserTRAM so it can
# handle large amounts of analytes without duplicate
# colors
colorlist = [
    "#2E91E5",
    "#E15F99",
...
app.layout = html.Div(
    [
        html.H1("Time Resolved Analysis of LA-ICP-MS data"),
        dcc.Tabs(
            [
                dcc.Tab(
                    label="LaserTRAM",
